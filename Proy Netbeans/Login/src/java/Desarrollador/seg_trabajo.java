 ...
 * @author Jorge
 */
public class seg_trabajo extends HttpServlet {
...
out.println("	");
out.println("	<title>MIZZI | Seguimiento Trabajo</title>");
out.println("	");
...
out.println("					<i class='entypo-ticket'></i>");
...
out.println("				<div class='panel-title'><h2>Seguimiento de trabajo</h2></div>");
out.println("				<div class='panel-options'>					");
out.println("					<ul class='nav nav-tabs bordered'>");
out.println("						<li class='active'><a href='#profile-1' data-toggle='tab'>Trabajo 1</a></li>");
out.println("						<li><a href='#profile-2' data-toggle='tab'>Trabajo 2</a></li>");
out.println("						<li><a href='#profile-2' data-toggle='tab'>Trabajo 3</a></li>");
out.println("					</ul>");
out.println("				</div>");
out.println("			</div>");
out.println("			");
...
out.println("			<h3>Trabajo 1</h3>");
out.println("			<br/>			");
out.println("			<h3>Progreso</h3>");
out.println("			<div class='row'>");
out.println("					");
out.println("				<div class='col-md-12'>");
out.println("					");
...
out.println("			</div>");
out.println("			<div class='row'>");
out.println("				<div class='col-md-3'>Cliente:</div>");
out.println("				<div class='col-md-3'>Lopez Perez Alex</div>	");
out.println("			</div>");
out.println("			<div class='row'>");
...
out.println("			<br/>");
out.println("			<div class='row'>");
out.println("				<div class='col-md-3'>Fecha de inicio:</div>");
out.println("				<div class='col-md-3'>20/06/17</div>	");
out.println("			</div>");
out.println("			<div class='row'>");
out.println("				<div class='col-md-3'>Fecha de termino:</div>");
out.println("				<div class='col-md-3'>29/06/17</div>	");
out.println("			</div>");
out.println("			<br/><br/>");
out.println("			<div class='row'>");
out.println("				<div class='col-md-12'><h3>Historial de avances</h3></div>");
out.println("			</div>");
out.println("			<div class='row'>	");
...
out.println("					Aqui trabajo 2");
out.println("			</div>");
out.println("			");
out.println("			<div class='tab-pane' id='profile-2'>");
out.println("					Aqui trabajo 3");
out.println("			</div>");
out.println("				");
out.println("		</div>");
out.println("		</div>		");
